...
namespace MyGL {
	...
	void Camera::move(Float x, Float y)
	{
		...
		(*((void(__fastcall**)(Camera* const, Float, Float, Float, double))this->_vptr_ICamera + 2))(
			this,
	...
	Camera* Camera::operator=(const Camera& c)
	{
		...
		v2 = (void(__fastcall*)(Camera* const, double, double, double, double)) * ((_QWORD*)this->_vptr_ICamera + 2);
		...
		v4 = (void(__fastcall*)(Camera* const, double, double, double)) * ((_QWORD*)this->_vptr_ICamera + 3);
		v12 = (*(double(__fastcall**)(const void* const))(*(_QWORD*)c + 104LL))(c);
		v5 = (*(double(__fastcall**)(const void* const))(*(_QWORD*)c + 96LL))(c);
		v4(this, v5, v12, 1.0);
		v6 = (void(__fastcall*)(Camera* const)) * ((_QWORD*)this->_vptr_ICamera + 4);
		(*(void(__fastcall**)(const void* const))(*(_QWORD*)c + 88LL))(c);
		v6(this);
		v7 = (void(__fastcall*)(Camera* const, double, double)) * ((_QWORD*)this->_vptr_ICamera + 5);
		v8 = (*(double(__fastcall**)(const void* const))(*(_QWORD*)c + 80LL))(c);
		v7(this, v8, 1.0);
		v9 = (void(__fastcall*)(Camera* const, _QWORD)) * ((_QWORD*)this->_vptr_ICamera + 15);
		v10 = (*(unsigned __int8(__fastcall**)(const void* const))(*(_QWORD*)c + 112LL))(c);
		v9(this, v10);
		return this;
	}
	CGL::GLdouble Camera::po(CGL::GLdouble x,
		CGL::GLdouble y,
		CGL::GLdouble z,
		CGL::GLdouble X,
		CGL::GLdouble Y,
