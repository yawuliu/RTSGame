 ...
 MyGL::IOModel::~IOModel()
{
 ...
 void MyGL::IOModel::allock(size_t vertexCount)
{
	(*((void(__fastcall**)(MyGL::IOModel* const))this->_vptr_IIOModel + 7))(this);
	this->msize = vertexCount;
	this->vert = (MyGL::CGL::GLfloat*)operator new[](12LL * this->msize);
	this->tex = (MyGL::CGL::GLfloat*)operator new[](8LL * this->msize);
	this->norm = (MyGL::CGL::GLfloat*)operator new[](12LL * this->msize);
	memset(this->vert, 0, 12LL * this->msize);
	memset(this->tex, 0, 8LL * this->msize);
	memset(this->norm, 0, 12LL * this->msize);
}

 void MyGL::IOModel::computeTBN()
{
	int v1;
	float v2;
	float v3;
	...
	MyGL::CGL::GLfloat* v8;
	__m128d v9;
	MyGL::CGL::GLfloat* v10;
	MyGL::CGL::GLfloat* v11;
	MyGL::CGL::GLfloat* v12;
	int i_1;
	float v14;
	float v15;
	float v16;
	...
	float tex2[4];
	float tex1[4];
	MyGL::IIOModel::TexCoord v23;
	MyGL::IIOModel::TexCoord v24;
	MyGL::IIOModel::TexCoord v25;
	MyGL::IIOModel::TexCoord v26;
	MyGL::IIOModel::Point v27;
	MyGL::IIOModel::Point v28;
	MyGL::IIOModel::Point v29;
	MyGL::IIOModel::Point v30;
	MyGL::IIOModel::Point4 v31;
	MyGL::IIOModel::Point4 v32;
	MyGL::IIOModel::Point4 v33;
	MyGL::IIOModel::Point4 v34;
	MyGL::IIOModel::Point4 v35;
	MyGL::IIOModel::Point4 v36;
	MyGL::IIOModel::Point4 v37;
	MyGL::IIOModel::Point4 v38;
	MyGL::IIOModel::Point4 v39;
	MyGL::IIOModel::Point4 v40;
	MyGL::IIOModel::Point4 v41;
	float k;
	int r_6;
	int r_5;
	int r_4;
	...
	(*((void(__fastcall**)(MyGL::IOModel* const))this->_vptr_IIOModel + 16))(this);
	v1 = (*((__int64(__fastcall**)(MyGL::IOModel* const))this->_vptr_IIOModel + 18))(this);
	if (v1 == 3 * (v1 / 3))
	{
		for (i = 0; ; i += 3)
		{
			i_1 = (*((__int64(__fastcall**)(MyGL::IOModel* const))this->_vptr_IIOModel + 18))(this);
			if (i_1 <= i)
				break;
			for (r = 0; r <= 1; ++r)
			{
				(*((void(__fastcall**)(MyGL::IIOModel::TexCoord*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 13))(
					&v23,
					this,
					(unsigned int)(i + 1));
				v18 = *MyGL::IIOModel::TexCoord::operator[](&v23, r);
				(*((void(__fastcall**)(MyGL::IIOModel::TexCoord*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 13))(
					&v24,
					this,
					(unsigned int)i);
				v2 = v18 - *MyGL::IIOModel::TexCoord::operator[](&v24, r);
				tex1[r] = v2;
				(*((void(__fastcall**)(MyGL::IIOModel::TexCoord*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 13))(
					&v25,
					this,
					(unsigned int)(i + 2));
				v17 = *MyGL::IIOModel::TexCoord::operator[](&v25, r);
				(*((void(__fastcall**)(MyGL::IIOModel::TexCoord*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 13))(
					&v26,
					this,
					(unsigned int)i);
				v3 = v17 - *MyGL::IIOModel::TexCoord::operator[](&v26, r);
				tex2[r] = v3;
			}
			for (r_0 = 0; r_0 <= 2; ++r_0)
			{
				(*((void(__fastcall**)(MyGL::IIOModel::Point*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 12))(
					&v27,
					this,
					(unsigned int)(i + 1));
				v16 = *MyGL::IIOModel::Point::operator[](&v27, r_0);
				(*((void(__fastcall**)(MyGL::IIOModel::Point*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 12))(
					&v28,
					this,
					(unsigned int)i);
				v4 = v16 - *MyGL::IIOModel::Point::operator[](&v28, r_0);
				pos1[r_0] = v4;
				(*((void(__fastcall**)(MyGL::IIOModel::Point*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 12))(
					&v29,
					this,
					(unsigned int)(i + 2));
				v15 = *MyGL::IIOModel::Point::operator[](&v29, r_0);
				(*((void(__fastcall**)(MyGL::IIOModel::Point*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 12))(
					&v30,
					this,
					(unsigned int)i);
				v5 = v15 - *MyGL::IIOModel::Point::operator[](&v30, r_0);
				pos2[r_0] = v5;
			}
			if (tex2[1] == 0.0)
			{
				if (tex2[0] == 0.0)
				{
					for (r_3 = 0; r_3 <= 2; ++r_3)
					{
						(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
							&v33,
							this,
							(unsigned int)i);
						*MyGL::IIOModel::Point4::operator[](&v33, r_3) = 0.0;
					}
				}
				else
				{
					for (r_2 = 0; r_2 <= 2; ++r_2)
					{
						(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
							...
							this,
							(unsigned int)i);
						v7 = MyGL::IIOModel::Point4::operator[](&v32, r_2);
						*v7 = pos2[r_2] / tex2[0];
					}
				}
			}
			else
			{
				...
				for (r_1 = 0; r_1 <= 2; ++r_1)
				{
					(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
						...
						this,
						(unsigned int)i);
					v6 = MyGL::IIOModel::Point4::operator[](&v31, r_1);
			...
			(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
				...
				this,
				(unsigned int)i);
			*MyGL::IIOModel::Point4::operator[](&v34, 3) = 0.0;
			*(float*)&l = 0.0;
			for (r_4 = 0; r_4 <= 2; ++r_4)
			{
				(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
					...
					this,
					(unsigned int)i);
				v14 = *MyGL::IIOModel::Point4::operator[](&v35, r_4);
				(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
					&v36,
					this,
					(unsigned int)i);
				v8 = MyGL::IIOModel::Point4::operator[](&v36, r_4);
			...
			*(float*)&l = _mm_unpacklo_pd(v9, v9).m128d_f64[0];
			for (r_5 = 0; r_5 <= 2; ++r_5)
			{
				(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
					...
					this,
					(unsigned int)i);
				v10 = MyGL::IIOModel::Point4::operator[](&v37, r_5);
				*v10 = *v10 / *(float*)&l;
			}
			for (r_6 = 0; r_6 <= 3; ++r_6)
			{
				(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
					...
					this,
					(unsigned int)(i + 1));
				v11 = MyGL::IIOModel::Point4::operator[](&v38, r_6);
				(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
					&v39,
					this,
					(unsigned int)i);
				*v11 = *MyGL::IIOModel::Point4::operator[](&v39, r_6);
				(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
					&v40,
					this,
					(unsigned int)(i + 2));
				v12 = MyGL::IIOModel::Point4::operator[](&v40, r_6);
				(*((void(__fastcall**)(MyGL::IIOModel::Point4*, MyGL::IOModel* const, _QWORD))this->_vptr_IIOModel + 15))(
					&v41,
					this,
					(unsigned int)i);
				*v12 = *MyGL::IIOModel::Point4::operator[](&v41, r_6);
			}
		}
	}
}

 void MyGL::IOModel::createExtra()
{
	if (!this->extra)
		this->extra = (MyGL::CGL::GLfloat*)operator new[](16LL * this->msize);
}

 void MyGL::IOModel::deleteExtra()
{
	if (this->extra)
 ...
 MyGL::IIOModel::Point4* MyGL::IOModel::exPoint(MyGL::IIOModel::Point4* __return_ptr retstr, int i)
{
	MyGL::IIOModel::Point4::Point4(retstr, &this->extra[4 * i]);
	return retstr;
}

 const MyGL::CGL::GLfloat* MyGL::IOModel::extraData()
{
	return this->extra;
}

 void MyGL::IOModel::free()
{
	this->msize = 0;
	if (this->vert)
 ...
 bool MyGL::IOModel::load(const std::string& fname)
{
	__int64 v2;
	bool v3;
	MyGL::CGL::GLfloat* v4;
	...
	__int64 v14;
	__int64 v15;
	MyGL::CGL::GLfloat* v17;
	MyGL::CGL::GLfloat* v18;
	_BYTE v19[540];
	int i;
 ...
 bool MyGL::IOModel::loadBin_v0(const std::string& fname)
{
	std::_Ios_Openmode v2;
	__int64 v3;
	bool v4;
	MyGL::IOModel* sh_data_1;
	_BYTE v7[264];
	__int64 v8;
	MyGL::IOModel::IOInfo info;
	unsigned int i;
	void* sh_data;
	...
	if ((unsigned __int8)std::fstream::is_open(v7))
	{
		...
		if (this->msize <= 512000)
		{
			...
			if ((unsigned __int8)std::ios::eof(&v8) != 1)
			{
				...
				{
					sh_data_1 = (MyGL::IOModel*)operator new(0x38uLL);
					MyGL::IOModel::IOModel(sh_data_1);
					sh_data = sh_data_1;
 ...
 MyGL::IOModel::Normal* MyGL::IOModel::normal(MyGL::IOModel::Normal* retstr, int i)
{
	MyGL::IIOModel::Point::Point(retstr, &this->norm[3 * i]);
	return retstr;
}

 const MyGL::CGL::GLfloat* MyGL::IOModel::normals()
{
	return this->norm;
}

 MyGL::IIOModel::Point* MyGL::IOModel::point(MyGL::IIOModel::Point* retstr, int i)
{
	MyGL::IIOModel::Point::Point(retstr, &this->vert[3 * i]);
	return retstr;
}

 const MyGL::CGL::GLfloat* MyGL::IOModel::points()
{
	return this->vert;
}

 bool MyGL::IOModel::save(const std::string& fname)
{
	__int64 v2;
	bool v3;
	__int64 v4;
 ...
 bool MyGL::IOModel::saveBin(const std::string& fname)
{
	std::_Ios_Openmode v2;
	__int64 v3;
	bool v4;
 ...
 int MyGL::IOModel::size()
{
	return this->msize;
}

 MyGL::IIOModel::TexCoord* MyGL::IOModel::texCoord(MyGL::IIOModel::TexCoord* retstr, int i)
{
	MyGL::IIOModel::TexCoord::TexCoord(retstr, &this->tex[2 * i]);
	return retstr;
}

 const MyGL::CGL::GLfloat* MyGL::IOModel::textureCoords()
{
	return this->tex;
}
