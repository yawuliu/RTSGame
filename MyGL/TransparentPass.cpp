...
MyGL::TransparentPass::TransparentPass(MyGL::IScene& s) : AbstractPass(s) {}

MyGL::TransparentPass::~TransparentPass() {}

void MyGL::TransparentPass::exec() {
	MyGL::IScene* v1;
	__int64 v2;
	MyGL::IScene* v3;
	void* s;
	...
	int i_1;
	MyGL::IGraphicsObject* obj_4;
	MyGL::IGraphicsObject* obj_3;
	int i_2;
	MyGL::IScene* v11;
	__int64 v12;
	...
	for (i = 0;; ++i) {
		...
		if (MyGL::TransparentPass::isDrawable(this, obj_2)) {
			obj_1 = MyGL::ISceneGraph::Visibles::operator[](&obj, i);
			MyGL::AbstractPass::drawObject<MyGL::TransparentPass>(this, obj_1);
		}
	}
	this->depthP = 0;
	for (i_0 = 0;; ++i_0) {
		i_2 = MyGL::ISceneGraph::Visibles::size(&obj);
		if (i_2 <= i_0)
			break;
		obj_4 = MyGL::ISceneGraph::Visibles::operator[](&obj, i_0);
		if (MyGL::TransparentPass::isDrawable(this, obj_4)) {
			obj_3 = MyGL::ISceneGraph::Visibles::operator[](&obj, i_0);
			MyGL::AbstractPass::drawObject<MyGL::TransparentPass>(this, obj_3);
		}
	}
...
bool MyGL::TransparentPass::isColorPass() {
	return !this->depthP;
}

bool MyGL::TransparentPass::isDepthPass() {
	return this->depthP;
}

bool MyGL::TransparentPass::isDrawable(MyGL::IGraphicsObject* const obj) {
	__int64 v3;
	__int64 v4;
	__int64 v5;
	__int64 v6;
	...
	if ((*((unsigned __int8(__fastcall**)(MyGL::IGraphicsObject* const)) obj->_vptr_IGraphicsObject + 9))(
		obj) != 1)
		return 0;
...
MyGL::IRenderPass::Pass::Type MyGL::TransparentPass::type() {
	return 8;
}
