...
MyGL::LightsCollection::LightsCollection(IScene& s)
{
...
MyGL::LightsCollection::~LightsCollection()
{
	ILight* v1;
	LightsCollection::pimpl* data;
...
void MyGL::LightsCollection::add(ILight& l)
{
...
void MyGL::LightsCollection::del(ILight& l)
{
...
void MyGL::LightsCollection::remove(ILight& l)
{
	std::vector<ILight*>::reference v2;
	LightsCollection::pimpl::size_type i;
...
IScene* MyGL::LightsCollection::scene()
{
	return this->mscene;
}

int MyGL::LightsCollection::size()
{
	return this->data->lights.size();
}

ILight* MyGL::LightsCollection::at(unsigned int id)
{
