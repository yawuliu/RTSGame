...
MyGL::SceneGraph::SceneGraph(MyGL::IScene& s) :scene(s) {}

void MyGL::SceneGraph::addObjectEvent(MyGL::IGraphicsObject& a2)
{
	;
}

void MyGL::SceneGraph::beginFrame(MyGL::IRenderPass& a2)
{
	(*((void(__fastcall**)(MyGL::SceneGraph* const))this->_vptr_ISceneGraph + 4))(this);
}

void MyGL::SceneGraph::beginFrame()
{
	this->updateCull();
	(*((void(__fastcall**)(MyGL::SceneGraph* const))this->_vptr_ISceneGraph + 8))(this);
}

void MyGL::SceneGraph::delObjectEvent(MyGL::IGraphicsObject* const a2)
{
	;
}
...
void MyGL::SceneGraph::getGl()
{
	...
	v1 = (*((__int64(__fastcall**)(MyGL::IScene* const))this->scene->_vptr_IScene + 3))(this->scene);
	(*(void(__fastcall**)(__int64, double*))(*(_QWORD*)v1 + 352LL))(v1, proj);
	v2 = (*((__int64(__fastcall**)(MyGL::IScene* const))this->scene->_vptr_IScene + 3))(this->scene);
...
bool MyGL::SceneGraph::isObjectVisible(const MyGL::IGraphicsObject& obj)
{
	__m128d v2;
	__m128d v3;
	__m128d v4;
	...
	v2.m128d_f64[0] = (*((double(__fastcall**)(const MyGL::IGraphicsObject* const))obj->_vptr_IGraphicsObject + 13))(obj);
	v3 = (__m128d)_mm_cvtpd_ps(_mm_unpacklo_pd(v2, v2));
	x = *(float*)v3.m128d_f64;
	v3.m128d_f64[0] = (*((double(__fastcall**)(const MyGL::IGraphicsObject* const))obj->_vptr_IGraphicsObject + 14))(obj);
	v4 = (__m128d)_mm_cvtpd_ps(_mm_unpacklo_pd(v3, v3));
	y = *(float*)v4.m128d_f64;
	v4.m128d_f64[0] = (*((double(__fastcall**)(const MyGL::IGraphicsObject* const))obj->_vptr_IGraphicsObject + 15))(obj);
	z = _mm_unpacklo_pd(v4, v4).m128d_f64[0];
	for (i = 0; i <= 5; ++i)
	{
		v7 = MyGL::SceneGraph::po(this, x, y, z, this->cullM[i][0], this->cullM[i][1], this->cullM[i][2], this->cullM[i][3]);
		v5 = (*((__int64(__fastcall**)(const MyGL::IGraphicsObject* const))obj->_vptr_IGraphicsObject + 20))(obj);
...
void MyGL::SceneGraph::normalization(double* const X, double* const Y, double* const Z, double* const D)
{
	double v5;
...
double MyGL::SceneGraph::po(double x, double y, double z, double X, double Y, double Z, double D)
{
...
void MyGL::SceneGraph::updateVisible()
{
	__int64 v1;
	unsigned __int8(__fastcall * v2)(MyGL::SceneGraph* const, __int64);
	__int64 v3;
	__int64 v4;
	std::vector<MyGL::IGraphicsObject*>::size_type nsize_1;
	std::vector<MyGL::IGraphicsObject*>::reference v6;
	__int64 v7;
	...
	nsize = 0LL;
	v1 = (*((__int64(__fastcall**)(MyGL::IScene* const))this->scene->_vptr_IScene + 9))(this->scene);
	objSize = (*(__int64(__fastcall**)(__int64))(*(_QWORD*)v1 + 64LL))(v1);
	for (i = 0LL; i < objSize; ++i)
	{
		v2 = (unsigned __int8(__fastcall*)(MyGL::SceneGraph* const, __int64)) * ((_QWORD*)this->_vptr_ISceneGraph + 7);
		v3 = (*((__int64(__fastcall**)(MyGL::IScene* const))this->scene->_vptr_IScene + 9))(this->scene);
		v4 = (*(__int64(__fastcall**)(__int64, size_t))(*(_QWORD*)v3 + 72LL))(v3, i);
		if (v2(this, v4))
		{
			nsize_1 = std::vector<MyGL::IGraphicsObject*>::size(&this->visObj);
			if (nsize_1 >= nsize)
			{
				__x = 0LL;
				std::vector<MyGL::IGraphicsObject*>::push_back(&this->visObj, &__x);
			}
			v6 = std::vector<MyGL::IGraphicsObject*>::operator[](&this->visObj, nsize);
			v7 = (*((__int64(__fastcall**)(MyGL::IScene* const))this->scene->_vptr_IScene + 9))(this->scene);
			*v6 = (MyGL::IGraphicsObject*)(*(__int64(__fastcall**)(__int64, size_t))(*(_QWORD*)v7 + 72LL))(v7, i);
			++nsize;
		}
	}
...
MyGL::IGraphicsObject* MyGL::SceneGraph::visible(int num)
{
	return  this->visObj[num];
}

int MyGL::SceneGraph::visiblesCount()
{
